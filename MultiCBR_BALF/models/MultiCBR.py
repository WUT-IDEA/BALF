...
class MultiCBR(nn.Module):
    ...
    def forward(self, batch, ED_drop=False):
        ...
        users, bundles = batch
        users_rep, bundles_rep, *rest = self.get_multi_modal_representations()
        ...
        return bpr_loss, c_loss, torch.tensor(0.0)


    def evaluate(self, propagate_result, users):
        users_feature, bundles_feature, *rest = propagate_result
